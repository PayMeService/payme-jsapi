...
// -----------------------------------------------------------------------------------------------------------------
  ...
  PayMe.create(mpl, {
    ...
    cardNumber.on('keyup', (e) => {
      ...
      e.isEmpty
        ? removeClass('card-expiration-group', 'animate-card-option')
        : addClass('card-expiration-group', 'animate-card-option');

      e.isEmpty
        ? removeClass('card-cvv-group', 'animate-card-option')
        : addClass('card-cvv-group', 'animate-card-option');
    });


    const expiration = fields.create(PayMe.fields.EXPIRATION, expirationFieldSettings);
    allFieldsReady.push(
    ...
    const cvc = fields.create(PayMe.fields.CVC, cvcFieldSettings);
    allFieldsReady.push(
    ...
    const phone = fields.create(PayMe.fields.PHONE, phoneFieldSettings);
    allFieldsReady.push(
    ...
    const email = fields.create(PayMe.fields.EMAIL, emailFieldSettings);
    allFieldsReady.push(
    ...
    const firstName = fields.create(PayMe.fields.NAME_FIRST, firstNameFieldSettings);
    allFieldsReady.push(
    ...
    const lastName = fields.create(PayMe.fields.NAME_LAST, lastNameFieldSettings);
    allFieldsReady.push(
    ...
    const socialId = fields.create(PayMe.fields.SOCIAL_ID, socialIdFieldSettings);
    allFieldsReady.push(
    ...
    form.addEventListener('submit', ev => {
      ...
      instance.tokenize(sale)
        ...
        .catch(err => {
          console.error(err);
          alert('Tokenization error!\nPlease check Web Developer Console');
          tokenizationFinished();
        });
    });
